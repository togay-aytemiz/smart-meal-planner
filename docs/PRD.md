...
- [x] Privacy Policy + Terms linkleri canlı ve uygulamada erişilebilir
...
- [x] Firestore rules prod güvenlik kontrolü (auth + role)
- [x] Functions error log + rate limit/abuse kontrolü (weekly menu rate limit)
...
- [x] iOS ATT izin metni + Info.plist açıklamaları tamam
- [x] Android izin listesi net (AD_ID, INTERNET, ACCESS_NETWORK_STATE)
...
- [x] `app-ads.txt` taslak hazır (docs/app-ads.txt)
